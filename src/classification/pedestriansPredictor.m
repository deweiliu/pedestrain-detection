...
function [updated_pedestrians] = pedestriansPredictor(pedestrians, svmModel)
        ...
        for frameindex = 1:nFrames
            for rowindex = 1:nRows
                for colindex = 1:nColumns
                    ...
                    label = predict(svmModel, pedestrians.sliding(scale).windows(rowindex, colindex, frameindex).features_HOG);
