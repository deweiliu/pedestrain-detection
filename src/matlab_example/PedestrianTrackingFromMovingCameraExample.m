%% Reference: https://uk.mathworks.com/help/vision/examples/tracking-pedestrians-from-a-moving-car.html
...
function PedestrianTrackingFromMovingCameraExample(videoFile, videoInfo)
    ...
    % The original file from Matlab documentation
    ...
    option.ROI = [1, 1, videoInfo.nColumns * 1.5, videoInfo.nRows * 1.5]; % A rectangle [x, y, w, h] that limits the processing area to ground locations.
    ...
    stopFrame = videoInfo.number; % stop on an interesting frame with several pedestrians
